<?php
  ...
  // Validamos que exista una session y ademas que el cargo que exista sea igual a1 (Administrador)
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Historial de Citas</h4>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-tools">
											<a href="../view/user_app/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
