	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<img src="../../assets/img/logoYAVIRAC.png" width="180px" height= "70px" >
				</a>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								<li>
									<div class="dropdown-title">Usted tiene 0 notificaciones</div>
								</li>
								<li>
									
								</li>
								<li>
									<a class="see-all" href="javascript:void(0);">Ver notificaciones<i class="fa fa-angle-right"></i> </a>
								</li>
							</ul>
						</li>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									<li>
										<a href="../user_app/historiamostrar.php">
											<span class="sub-item">Mostrar</span>
										</a>
									</li>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Historia clinica</h2>
							...
							<div class="card">
								<div class="card-body">
									<div class="card-title fw-mediumbold">Tratamiento</div>
										<div class="item-list">
											<div class="info-user ml-3">
												<p>Se recomienda asistir a una consulta semanal para dar seguimiento a la ansiedad y tomar complejo B cada 12 horas para controlar estres</p>
											</div>
										</div>
									</div>
					</div>
